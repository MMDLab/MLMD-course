...
| <span style="color:orange">  Practical work 1 </span> | Introduction to the Materials Project Database | *A 1* | - |
| <span style="color:orange"> Home work 1 </span> | Materials Project REST-API | *A 2* | - |
...
| <span style="color:orange"> Practical work 2 </span> | - Coulomb potantial for non-periodic system  <br> - Coulomb potantial for infinite periodic system | *A 3* | - |
| <span style="color:orange"> Home work 2 </span> | Dataset normalization | *A 4* | - |
|  | 
| **DFT** | Fundamentals of application of the electron density functional theory | *Lect* | 4 |
| ?? | - ?? <br> - ?? </span> | *Pract* | 2 |
| <span style="color:orange"> Practical work 3 </span> | | *A 3* | - |
| <span style="color:orange"> Home work 3 </span> | | *A 4* | - |
